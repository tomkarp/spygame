...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'VerdeckeKarte':
				var n = msg.a;
				return (_Utils_cmp(n, model.anzahlSpieler) < 1) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
			...
			default:
				return _Utils_Tuple2(
					_Utils_update(
						...
						{anzahlSpieler: model.anzahlSpieler, begriffe: model.begriffe}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$Reset = {$: 'Reset'};
var $author$project$Main$Starten = {$: 'Starten'};
var $author$project$Main$VerdeckeKarte = function (a) {
	return {$: 'VerdeckeKarte', a: a};
};
var $author$project$Main$ZeigeKarte = function (a) {
	return {$: 'ZeigeKarte', a: a};
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$NeueSpielerzahl(anzahl - 1))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('-')
	...
	switch (_v0.$) {
		case 'Vorbereitung':
			return A2(
				$elm$html$Html$div,
				_List_Nil,
				_Utils_eq(model.begriffe, _List_Nil) ? _List_fromArray(
					[
						A2(
						$elm$html$Html$h1,
						_List_Nil,
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Keine Begriffe mehr vorhanden')
							]))
					]) : _List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$Starten)
							]),
						_List_fromArray(
							[
		...
		case 'OffeneKarte':
			...
			if (_v1.$ === 'Nothing') {
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Fehler, bitte neu starten')
						]));
			} else {
				var spionnummer = _v1.a;
				return A2(
					$elm$html$Html$div,
					_List_Nil,
					_List_fromArray(
						[
							...
							_Utils_eq(n, spionnummer) ? A2(
							$elm$html$Html$p,
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('begriff')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('Spion')
								])) : A2(
							$elm$html$Html$p,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									A2($elm$core$Maybe$withDefault, 'Ungültiger Begriff', model.aktuellerBegriff))
								])),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick(
									$author$project$Main$VerdeckeKarte(n + 1))
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Klicke auf \'Weiter\' und gib dann das Gerät weiter')
								]))
						]));
			}
		case 'VerdeckteKarte':
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('umdrehhinweis')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('???')
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$ZeigeKarte(n))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Zeige Karte')
							]))
					]));
		default:
			return A2(
